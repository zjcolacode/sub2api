...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		HomePromoEnabled:                       settings.HomePromoEnabled,
		HomePromoText:                          settings.HomePromoText,
...
type UpdateSettingsRequest struct {
	...
	HomePromoEnabled            bool                  `json:"home_promo_enabled"`
	HomePromoText               string                `json:"home_promo_text"`
...
func (h *SettingHandler) UpdateSettings(c *gin.Context) {
	...
	settings := &service.SystemSettings{
		...
		HomePromoEnabled:                       req.HomePromoEnabled,
		HomePromoText:                          req.HomePromoText,
	...
	payload := dto.SystemSettings{
		...
		HomePromoEnabled:                       updatedSettings.HomePromoEnabled,
		HomePromoText:                          updatedSettings.HomePromoText,
...
func diffSettings(before *service.SystemSettings, after *service.SystemSettings, beforeAuthSourceDefaults *service.AuthSourceDefaultSettings, afterAuthSourceDefaults *service.AuthSourceDefaultSettings, req UpdateSettingsRequest) []string {
	...
	if before.HomePromoEnabled != after.HomePromoEnabled {
		changed = append(changed, "home_promo_enabled")
	}
	if before.HomePromoText != after.HomePromoText {
		changed = append(changed, "home_promo_text")
	}
